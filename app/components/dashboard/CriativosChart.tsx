...
import type { Criativo } from '../../types/dashboard'
    ...
    return (
        <div>
            ...
            <div className="mt-5 space-y-2.5 max-h-[220px] overflow-y-auto pr-1">
                {top10.map((c, i) => (
                    <div key={`${c.anuncio}-${c.campanha}-${i}`} className="flex items-start gap-3 p-3 rounded-xl hover:bg-accent/30 transition-colors border border-transparent hover:border-border">
