...
search_term = "rewriteMessageViaLLM"
        ...
        if file.endswith(".ts"):
            ...
            with open(path, "r", encoding="utf-8") as f:
                ...
                if search_term in content:
                    ...
                    # Write lines around it to scratch/rewrite_code.txt
                    ...
                    for idx, line in enumerate(lines):
                        if search_term in line:
                            ...
                            break
                    if start != -1:
                        with open(r"c:\Users\Note\Desktop\Antigravity\AutomacaoZAP\scratch\rewrite_code.txt", "w", encoding="utf-8") as f_out:
